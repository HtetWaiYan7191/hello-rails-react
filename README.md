...
```bash
  git clone https://github.com/HtetWaiYan7191/hello-rails-react/
```
...
- GitHub: [@HtetWaiYan](https://github.com/HtetWaiYan7191)
...
Feel free to check the [issues page](https://github.com/HtetWaiYan7191/hello-rails-react/issues).
